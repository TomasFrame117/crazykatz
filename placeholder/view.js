...
function forumPage() {
    ...
    var modal = document.getElementsByName("forumPiceModal");
    var btn = document.getElementsByName("forumPice");
    ...
    <div class="page">
        ...
        <div class="mainContent">
            ...
            <div class="grid-item">Vi har en jentepus på 2.5 år. Hun er svært lite kosete...
                <button name="forumPice" class="a1">Les mer</button>
                <div name="forumpiceModal" style="modal">
                <span class="close">&times;</span>
                <p>Some text in the Modal..</p>
                </div>

            </div>
            <div class="grid-item">Kan katten høre at det er eieren som kommer gående?
                <button class="a1">Les mer</button>
            </div>
            <div class="grid-item">Hvorfor hater katter å få vann på seg?
                <button class="a1">Les mer</button>
            </div>
            <div class="grid-item">Hvor fort kan en katt løpe?
                <button class="a1">Les mer</button>
            </div>
            <div class="grid-item">Hvor langt går katter?
                <button class="a1">Les mer</button>
            </div> 
            </div>
