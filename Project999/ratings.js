function ratingsPage() {
  ...
  function makeRadiobuttons(verdi) {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      <div class="stara"><input class="ratingsScoreBtn" onclick="model.input.ratingInfo.${verdi} = parseInt(this.value)" type="radio" value="${
        i + 1
      }">${i + 1}</input></div>`;
    }
    return html;
  ...
  function makeOverAllRdioBtns(verdi) {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      <div class="stara"><input class="ratingsScoreBtn" onclick="model.input.ratingInfo.Overall.${verdi} = parseInt(this.value)" type="radio" value="${
        i + 1
      }">${i + 1}</input></div>
